...
array_push($profileData, $firstName, $lastName, $birthDate, $joinDate, $address, $homePhone, $cellPhone, $email, $eContact, $medicalProvider, $referredBy, $memberId, $userImage, $level);
...
{
  $popUp = new PopUpManager;
  $content = "<h2>Error on inserting new member record.  Member Not added</h2>";
